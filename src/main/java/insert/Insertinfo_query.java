...
import com.hdd.szdb.domain.Info_query;

public class Insertinfo_query {
	public static void main(String[] args) throws Exception{
		String csvRoot = "data/sz/";
		String tableName = "info_query.csv";
		...
		for(int i=0;i<list.size();i++){
			...
			for(int j=0;j<a.length;j++){
				idi.setAPPL_ID(a[0]);
				idi.set信贷审批明细查询原因(a[1]);
				idi.setQuery_date(a[2]);
				idi.setQuery_no(a[3]);
