...
public class InsertPboc_qcredit_overdue {

	public static void main(String[] args) throws Exception{
		String csvRoot = "data/data_dev/";
		String tableName = "Pboc_qcredit_overdue.csv";
...
/*		ReadCsvLine rcl = new ReadCsvLine();
		...
		for(int i=0;i<list.size();i++){
			Pboc_qcredit_overdue idi = new Pboc_qcredit_overdue();
			idi.setId((long)(i+1));
			...
			for(int j=0;j<a.length;j++){
				idi.setReportId(a[0]);
				idi.setPboc_qcredit_overdue_qcredit_num(a[1]);
				idi.setPboc_qcredit_overdue_OverdueAmount(a[2]);
				idi.setPboc_qcredit_overdue_OverdueMonthNum(a[3]);
				idi.setPboc_qcredit_overdue_OverdueMonth(a[4]);
