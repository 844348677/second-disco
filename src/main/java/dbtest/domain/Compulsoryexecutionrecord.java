...
public class Compulsoryexecutionrecord {
	...
	private String Compulsoryexecutionrecord_CaseState;
	...
	public void setExecutiveCaseReason(String executiveCaseReason) {
		ExecutiveCaseReason = executiveCaseReason;
	}
	...
	public void setApplyExecSubject(String applyExecSubject) {
		ApplyExecSubject = applyExecSubject;
	}
	...
	public void setAlreadyExecSubject(String alreadyExecSubject) {
		AlreadyExecSubject = alreadyExecSubject;
	}
	...
	public void setApplyExecSubjectValue(String applyExecSubjectValue) {
		ApplyExecSubjectValue = applyExecSubjectValue;
	}
	...
	public void setAlreadyExecSubjectValue(String alreadyExecSubjectValue) {
		AlreadyExecSubjectValue = alreadyExecSubjectValue;
	}

	public String getCompulsoryexecutionrecord_CaseState() {
		return Compulsoryexecutionrecord_CaseState;
	}

	public void setCompulsoryexecutionrecord_CaseState(String compulsoryexecutionrecord_CaseState) {
		Compulsoryexecutionrecord_CaseState = compulsoryexecutionrecord_CaseState;
	}
